						...
						echo "
							<table class='table-fill' height=400px border=1 width=100% style='overflow:hidden;text-align:center;'>";
									...
									if($row['TEAM1'] !=NULL)
									{
										...
										echo "<tr ><td style='background:#4E5066;' colspan=2><a class='match1' href='scorecard.php?id=".$row['MATCH_ID']."'><span style='color:#ffffff'>".$row4['TEAM_NAME']."</span><span style='color:#29088A'> vs ".$row3['TEAM_NAME']."</span></a></td></tr>";
										echo "<tr><td colspan=2>".$row['TOSS']." won the toss and chose to ".$row['TOSS_DECISION']."</td></tr>";
