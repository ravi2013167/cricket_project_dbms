...
<?php
	...
	if($iswicket==1) { $bww=$bww+1;echo "kdjfldjugal";
		if($howwicket=='w') {
			...
			$qry="INSERT INTO balls VALUES('".$match."',".$inning.",".$over.",".$runs.",'b ".$bowler1." r ".$whowicket1."',".$extras.",'".$striker."','".$bowler."')";
		} else {
	...
	if($iswicket==1) {echo 'yesb';
		if($howwicket=='w') {
			...
			$qry1="UPDATE plays_in set RUN_SCORED=RUN_SCORED+".$btrs.",RUN_CONCEDED=RUN_CONCEDED+".$btrc.",OVER_BOWLED=OVER_BOWLED+".$btob.",BALL_PLAYED=BALL_PLAYED+".$btbp.",SIXES=SIXES+".$bts.",FOURS=FOURS+".$btf.",WICKET=WICKET+".$btw.",OUTS='b ".$bowler1." r ".$whowicket1."' WHERE MATCH_ID='".$match."' AND PLAYER_ID='".$striker."'";
			$qry2="UPDATE plays_in set RUN_SCORED=RUN_SCORED+".$bwrs.",RUN_CONCEDED=RUN_CONCEDED+".$bwrc.",OVER_BOWLED=OVER_BOWLED+".$bwob.",BALL_PLAYED=BALL_PLAYED+".$bwbp.",SIXES=SIXES+".$bws.",FOURS=FOURS+".$bwf.",WICKET=WICKET+".$bww." WHERE MATCH_ID='".$match."' AND PLAYER_ID='".$bowler."'";
		} else if($howwicket=='r') {
