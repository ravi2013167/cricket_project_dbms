	...
	<body id="body">
		<div id="container1">
			...
			<ul>
			   ...
			   <li class='active fix'><a href='contactus.php'><span>Contact</span></a></li>
			</ul>
			</div>
			<br><br>
				...
				<?php
					echo "<div class='CSSTableGenerator'>";
						echo "<table style='width:435px;'>";
							...
							echo "</tr>";
							echo "<tr>";
								echo "<td style='height:300px;'><img src='images/ravi.jpg' height='250px' width='250px'></td>";
							echo "</tr>";
							echo "<tr>";
				...
				<?php
					echo "<div class='CSSTableGenerator'>";
						echo "<table style='width:435px;'>";
							...
							echo "</tr>";
							echo "<tr>";
								echo "<td style='height:300px;'><img src='images/jugal.jpg' height='250px' width='250px'></td>";
							echo "</tr>";
							echo "<tr>";
				...
				<?php
					echo "<div class='CSSTableGenerator'>";
						echo "<table style='width:435px;'>";
							...
							echo "</tr>";
							echo "<tr>";
								echo "<td style='height:300px;'><img src='images/image.jpg' height='250px' width='250px'></td>";
							echo "</tr>";
							echo "<tr>";
