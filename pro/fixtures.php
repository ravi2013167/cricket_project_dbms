...
<html>
	...
	<body id="body">
		<div id="container1">
			...
			<br><br>
			<center><table ><tr><td><center><h1><b>FIXTURES</center><b></h1></td></tr></table>
			<?php
					$match='M1';
					include('dbms.php');
					...
					echo "<br><br><br>";
					echo "<div>";
						echo "<table   style = 'width:90%;margin:auto;text-align:center;color:white;' >";
							echo '<tr style="width:100%" id="fix_head">';
								echo "<td style='width:100%' colspan='4'><h3>".$inning1." vs ".$inning2." (".$row['VENUE'].") - ".$shedule."</h3></td>";
							echo '</tr>';
							echo '<tr style="width:100%;background-color:#2b2948">';
								echo "<td><b><img src='".$inning1.".jpg' height='60px' width='100px'>";
								echo "<td>vs</td>";
								echo "<td><b><img src='".$inning2.".jpg' height='60px' width='100px'>";
								echo "<td rowspan='1' style='width:40%'><b>".$description." <b></td>";
							echo "</tr>";
							echo "<tr style='background-color:#2b2948'>";
								echo "<td><b>".$run1."/".$wicket1."</b></td>";
								echo "<td><b><a class='fixture' href='scorecard.php?id=".$match."'>DETAILS</a></b></td>";
