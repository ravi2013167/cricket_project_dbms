		...
		<div id="container1">
				...
				<table id='imge'>
					<tr id='imgshow'>
						<td id="imagg" width=74.5%>
							...
							<div align="middle" class="container1">
								...
								<div class="sp-slideshow">
									...
									<div class="sp-content" >
										...
										<ul class="sp-slider clearfix" >
											<li><img src="images/img1.jpg" alt="image01" /></li>
											<li><img src="images/img2.jpg" alt="image02" /></li>
											<li><img src="images/img3.jpg" alt="image03" /></li>
											<li><img src="images/img4.jpg" alt="image04" /></li>
											<li><img src="images/img5.jpg" alt="image05" /></li>
										</ul>
									</div><!-- sp-content -->
								</div><!-- sp-slideshow -->
			...
			<div id="play">
							...
							<td class="overflow" style="padding-left:0;">
								...
								<?php
									...
									if($row['TEAM1'] !=NULL)
									{
										...
										$var = 'images/'.$row['TEAM1'].'.jpg';
										$var2 = 'images/'.$row['TEAM2'].'.jpg';
										$score=1;
										
										echo "<span class='span1' style='background-color:green;'>&nbsp;Live&nbsp;</span><br>".$stage."<br><br>";
										echo "<a class='match2' href='scorecard.php?id=".$row['MATCH_ID']."'><span> ".$row2['TEAM_NAME']." vs ".$row3['TEAM_NAME']."</span></a><br>";
							...
							<td class="overflow2" style="padding-right:0;">
								...
								<?php
									...
									if($row['TEAM1'] !=NULL)
									{
										...
										$var = 'images/'.$var3.'.jpg';
										$var2 = 'images/'.$row3['TEAM_ID'].'.jpg';
										
										echo "<span class='span1' style='background-color:#DF7401;'>&nbsp;Concluded&nbsp;</span><br>".$stage."<br><br>";
										echo "<a class='match1' href='scorecard.php?id=".$row['MATCH_ID']."'><span style='color:#ffffff'>".$row4['TEAM_NAME']."</span><span style='color:#abcdef'> vs ".$row3['TEAM_NAME']."</span></a><br>";
										echo "<br><img src=$var style='height:200px;width:200px;'></img>
											<img src=$var2 style='height:200px;width:200px;'></img>
											<br><br>Result - ";
										...
										echo "<span class='span1' style='background-color:#DF7401;'>&nbsp;Concluded&nbsp;</span><br>".$stage."<br><br>";
										echo "<a class='match2' href='scorecard.php?id=".$row['MATCH_ID']."'><span>".$row2['TEAM_NAME']."</span><span> vs ".$row3['TEAM_NAME']."</span></a><br>";
				...
				<?php
					if($score){
						echo "
							<table class='table-fill' height=100%  width=100% style='text-align:center;'>";
									...
									echo "<tr ><td style='background:#4E5066;' colspan=2><a class='match2' href='scorecard.php?id=".$row['MATCH_ID']."'><span>".$row2['TEAM_NAME']."</span><span > vs ".$row3['TEAM_NAME']."</span></a></td></tr>";
									...
									if($toss!="") {
										...
										$result4=mysql_query($qry6);
										$row5=mysql_fetch_assoc($result4);
										$qry2="SELECT SCORE_WICKET FROM plays WHERE MATCH_ID ='".$row['MATCH_ID']."' AND TEAM_ID='".$i1['inning1']."'";
										$result4=mysql_query($qry2);
										$roww=mysql_fetch_assoc($result4);
										
										if($roww['SCORE_WICKET']!=0)
										...
										$qry5="SELECT PLAYER_ID, WICKET, RUN_CONCEDED FROM plays_in WHERE MATCH_ID ='".$row['MATCH_ID']."' AND PLAYER_ID LIKE '".$i1['inning2']."%' ORDER BY RUN_CONCEDED DESC";
										$result3=mysql_query($qry5);
										$row4=mysql_fetch_assoc($result3);
										$qry6="SELECT PLAYER_NAME FROM players WHERE PLAYER_ID = '".$row4['PLAYER_ID']."'";
										$result4=mysql_query($qry6);
										...
										$result4=mysql_query($qry6);
										$row5=mysql_fetch_assoc($result4);
										$qry2="SELECT SCORE_WICKET FROM plays WHERE MATCH_ID ='".$row['MATCH_ID']."' AND TEAM_ID='".$i1['inning2']."'";
										$result4=mysql_query($qry2);
										$roww=mysql_fetch_assoc($result4);
										...
										$qry5="SELECT PLAYER_ID, WICKET, RUN_CONCEDED FROM plays_in WHERE MATCH_ID ='".$row['MATCH_ID']."' AND PLAYER_ID LIKE '".$i1['inning1']."%' ORDER BY RUN_CONCEDED DESC";
										$result3=mysql_query($qry5);
										$row4=mysql_fetch_assoc($result3);
										$qry6="SELECT PLAYER_NAME FROM players WHERE PLAYER_ID = '".$row4['PLAYER_ID']."'";
										$result4=mysql_query($qry6);
						...
						echo "
							<table class='table-fill' height=400px  width=100% style='overflow:hidden;text-align:center;'>";
									...
									if($row['TEAM1'] !=NULL)
									{
										...
										echo "<tr ><td style='background:#4E5066;' colspan=2><a class='match1' href='scorecard.php?id=".$row['MATCH_ID']."'><span style='color:#ffffff'>".$row4['TEAM_NAME']."</span><span style='color:lightblue'> vs ".$row3['TEAM_NAME']."</span></a></td></tr>";
										echo "<tr><td colspan=2>".$row['TOSS']." won the toss and chose to ".$row['TOSS_DECISION']."</td></tr>";
